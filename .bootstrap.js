...
const PROJECT_NAME = "suitewaste-os-lv7iczrpfcemqtlbdx0vv";
...
function runSetupCommands() {
    const commands = [
    "bun add rxdb@^16.10.0 @rxdb/storage-pouchdb pouchdb-browser pouchdb-adapter-idb rxdb-hooks workbox-window@^7.1.0 react-signature-canvas@^1.0.7",
    "bun add pouchdb-adapter-idb@^7.2.1",
    "bun add rxjs@^7.8.1",
    "bun add workbox-window@^7.1.0",
    "bun add react-signature-canvas@^1.0.7",
    "bun install rxdb pouchdb-adapter-idb rxjs",
    "bun install @tanstack/react-query-devtools",
    "bun install rxdb-hooks",
    "bun add rxdb-hooks",
    "bun install pouchdb-browser",
    "bun add rxdb",
    "bun add @rxdb/storage-pouchdb",
    "bun add pouchdb-browser",
    "bun add pouchdb-adapter-idb",
    "bun add workbox-window",
    "bun add react-signature-canvas",
    "bun add @rxdb/storage-indexeddb",
    "bun add @rxdb/storage-memory",
